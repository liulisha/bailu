...
var Main = (function (_super) {
    ...
    Main.prototype.createGameScene = function () {
        //加入声音
        var sound = RES.getRes("Timbaland&OneRepublic-Apologize_mp3");
        ...
        this.addChild(bg);
        //显示一个图片
        var batman1 = new egret.Bitmap(RES.getRes("ni_png_0119_png"));
        batman1.x = 50;
        batman1.y = 300;
        ...
        //显示一个图片
        var batman2 = new egret.Bitmap(RES.getRes("ni_png_0120_png"));
        batman2.x = 120;
        batman2.y = 300;
        this.addChild(batman2);
        this.setChildIndex(batman2, 1);
        //显示一个图片
        var batman3 = new egret.Bitmap(RES.getRes("ni_png_0121_png"));
        batman3.x = 200;
        batman3.y = 300;
        ...
        //显示一个图片
        var batman4 = new egret.Bitmap(RES.getRes("ni_png_0122_png"));
        batman4.x = 270;
        batman4.y = 300;
